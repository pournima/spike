	...
	public class RetrieveAccessTokenTask extends AsyncTask<Uri, Void, Void> {
		...
		protected Void doInBackground(Uri...params) {
			...
			try {
				...
				appStatus.saveSharedStringValue(appStatus.TWITTER_SECRET, secret);
		...
		private void getFollowerList() {
			...
			try {
				...
				Log.i("Twitter followers count : ", String.valueOf(obj.getIDs().length));
				...
				appStatus.saveSharedStringValue(appStatus.TW_FIRST_NAME,firstName);
				appStatus.saveSharedStringValue(appStatus.TW_LAST_NAME,lastName);
				appStatus.saveSharedStringValue(appStatus.TW_UID,String.valueOf(userID));
