...
public class AppStatus {
	...
	public final String ALL_BUS_CUR_PAGE  = "all_bus_cur_page";
	public final String MY_BUS_CUR_PAGE   = "my_bus_cur_page";
	public final String ALL_ORG_CUR_PAGE   = "my_org_cur_page";

	public final String FACEBOOK_PERMISSIONS_ON = "fb_permissions_on";
	
	public final String APP_USER_LINK = "app_user_link";
	public final String APP_USER_COVER = "app_user_cover";
	public final String OVERVIEW_LINK = "overview_link";
	public final String OVERVIEW_COVER = "overview_cover";
	public final String GROW_BUS_LINK = "grow_bus_link";
	public final String GROW_BUS_COVER = "grow_bus_cover";
	
	public final String MY_CAUSES_UPGRADE_NEEDED  = "my_causes_upgrade";
	public final String ALL_CAUSE_UPGRADE_NEEDED  = "all_causes_upgrade";
