...
class Authenticator extends AbstractAccountAuthenticator {
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response,
        ...
        // return an error
        if (!authTokenType.equals("checkinforgood.com")) {
        ...
        if (password != null) {
            final LoginResult lresult = LoginWebService.login(mContext, account.name, password);
            final String authToken = lresult.getApiKey();
