package com.campaignslibrary.calender;
...
import com.campaignslibrary.R;
import com.checkinlibrary.CheckinLibraryActivity;

public class SimpleCalendarViewFragment extends Fragment implements OnClickListener {
	...
	public Boolean bIsDateSelected = false;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View fragmentView = inflater.inflate(R.layout.simple_calendar_view, container, false);
	...
	private void initialization(View v) {
		...
		selectedDayMonthYearButton = (TextView) v.findViewById(R.id.selectedDayMonthYear);
...
//			Log.d(tag, "Setting GridCell " + theday + "-" + themonth + "-" + theyear);
			...
			if (day_color[1].equals("BLUE")) {
				...
				gridcell.setBackgroundResource(R.drawable.day_selected);
			}
			return row;
		}
		...
		public void onClick(View view) {
			...
			strSelectedDate = (String) view.getTag();
			selectedDayMonthYearButton.setText("Selected: " + strSelectedDate);

			//try {
				//Date parsedDate = dateFormatter.parse(strSelectedDate);
