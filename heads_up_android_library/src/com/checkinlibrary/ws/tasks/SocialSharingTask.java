...
import com.checkinlibrary.settings.DelinkShareActivity;
...
public class SocialSharingTask extends AsyncTask<String, Integer, Boolean>{
	...
	private SocialSharingActivity socialShareContext;
	private DelinkShareActivity delinkFragContext;
	...
	public final int SIGNUP_FRAG=5;
	...
	/*public SocialSharingTask(SocialSharingActivity shareContext,int iWebSerViceFlag) {
		this.socialShareContext=shareContext;
		this.mWebSeviceFlag=iWebSerViceFlag;//0;
		this.mIFileFlag=SHARE_FRAG;
	}*/
	
	public SocialSharingTask(SignupActivity SignUPContext,int iWebSerViceFlag) {
		this.signupContext=SignUPContext;
		this.mWebSeviceFlag=iWebSerViceFlag;//2;
		this.mIFileFlag=SIGNUP_FRAG;
	}
	
	public SocialSharingTask(DelinkShareActivity deLinkContext,int iWebSerViceFlag) {
	...
	protected void onPostExecute(Boolean result) {
		...
		else if(mIFileFlag == SIGNUP_FRAG) 
			this.signupContext.onAuthenticationResult(result);
	} 
}
