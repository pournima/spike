...
abstract public class DbAdapter {
    ...
    protected static CheckinDatabaseHelper dbHelper;
    ...
    final public static void open(Context context) throws SQLException {
        dbHelper = new CheckinDatabaseHelper(context);
        try {
            db = dbHelper.getWritableDatabase();
        } catch ( SQLiteException e ) {
            Log.w("CHECKINFORGOOD", "OrganizationDbAdapter::getWritableDatabase error: " + e.getMessage());
        }        
    }
