...
public class HowItWorks extends Activity {
	...
	String[] Videos = {
			"http://www.youtube.com/watch?v=s3_vHc_Mpu0&feature=youtu.be&noredirect=1",
	...
	private void InitAllComponents() {
		...
		scripScroll0 = (ScrollView) findViewById(R.id.scripScroll0);
		scripScroll1 = (ScrollView) findViewById(R.id.scripScroll1);
		scripScroll2 = (ScrollView) findViewById(R.id.scripScroll2);
		scripScroll3 = (ScrollView) findViewById(R.id.scripScroll3);
		scripScroll4 = (ScrollView) findViewById(R.id.scripScroll4);
		scripScroll5 = (ScrollView) findViewById(R.id.scripScroll5);

		textBusinessText = (TextView) findViewById(R.id.textBusinessTap);
		// Set HTML text in TextView
		textBusinessText.setText(Html.fromHtml(getResources().getString(
				R.string.how_it_works_business_tap)));
		
		txtHowItWorksRules = (TextView) findViewById(R.id.txtHowItWorksRules);
		txtHowItWorksRules.setText(Html.fromHtml(getResources().getString(
				R.string.how_it_works_rules_tap)));
		
		txtHowItWorksSafety = (TextView) findViewById(R.id.txtHowItWorksSafety);
		...
		slideLeftIn = AnimationUtils
				.loadAnimation(this, R.layout.slide_in_left);
		...
		imgViewVideo = (ImageView) findViewById(R.id.imageViewVideo);

		imgViewVideo.bringToFront();
		btnSettingShare = (Button) findViewById(R.id.btnSettingShare);
	...
	private void playVideo(int iIndex) {
	...
	private void initialiseCurrentPageView() {
		imgViewCurrentPage[0] = (ImageView) findViewById(R.id.img_hiw_slider_panel1);
		imgViewCurrentPage[1] = (ImageView) findViewById(R.id.img_hiw_slider_panel2);
		imgViewCurrentPage[2] = (ImageView) findViewById(R.id.img_hiw_slider_panel3);
		imgViewCurrentPage[3] = (ImageView) findViewById(R.id.img_hiw_slider_panel4);
		imgViewCurrentPage[4] = (ImageView) findViewById(R.id.img_hiw_slider_panel5);
		imgViewCurrentPage[5] = (ImageView) findViewById(R.id.img_hiw_slider_panel6);
